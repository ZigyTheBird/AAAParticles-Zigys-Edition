...
import com.zigythebird.zigys_particles.client.registry.EffectDefinition;
import com.zigythebird.zigys_particles.api.client.effekseer.EffekseerEffect;
import com.zigythebird.zigys_particles.api.client.effekseer.TextureType;
...
public class EffekAssetLoader extends SimplePreparableReloadListener<EffekAssetLoader.Preparations> {
    ...
    private void load(
        ...
        for (int i = 0; i < count; i++) {
            ...
            var main = ResourceLocation.fromNamespaceAndPath(modid, mcAssetPath);
            var fallback = ResourceLocation.fromNamespaceAndPath(modid, fallbackMcAssetPath);
            // Load from disk.
